...
public class PosTreeTagger extends PosTagger {
    ...
    public String run() {
        try {
            ...
            //System.out.println("TreeTagger Path: "+path + " on: "+input);
           ...
           // System.out.println("Output XPOS: "+output+ getXPOS());
            String[] split;
            String inputLine;
            String line = "";
            int tokCount = 0;
            ...
            while ((inputLine = brIn.readLine()) != null) {
               ...
               // System.out.println(" TOKENS: "+tokCount+" \nLINE: "+inputLine);
                ...
                completeLine = "";
                //System.out.println(" TOKENS: "+completeLine.length()+" \nLINE: "+inputLine.length());
